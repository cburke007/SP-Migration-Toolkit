...
# Region Document the Web Applications and properties
...
foreach($wa in $webapps)
{
    ...
    $ContentDBs = Get-SPContentDatabase -WebApplication $wa
    ...
    $altURLs = Get-SPAlternateURL -WebApplication $wa
...
# EndRegion Document Service Apps
